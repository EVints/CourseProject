...
<div class="wrapper row3">
    <main class="hoc container clear">
        ...
        <form method="post" action="/journey/admin/create" id="create_advert">
            @csrf
            ...
            <ul id="advert_ul">
                ...
                <li>
                    ...
                    <input type="text" name="start_address" id="start_address" required>
                </li>


                <li>
                    <input type="datetime-local" name="time_to" id="time_to" value="Окончание поездки" required>
                </li>
